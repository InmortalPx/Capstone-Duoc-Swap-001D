para correrlo es simple:                                                          paso 1: tener instalado python.                
paso 2: configurar la base de datos. descargar mariadb, cambiar contraseña, revisar el puerto el nombre de la base de datos todo que coincida con la configuración en Setting: DATABASES = {
    'default': {
