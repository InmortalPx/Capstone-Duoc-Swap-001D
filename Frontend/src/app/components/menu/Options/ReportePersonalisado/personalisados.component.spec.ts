...
describe ('PersonalisadoComponent', () => 
  ...
  it('should display borrowed tools information', () => {
    const fixture = TestBed.createComponent(PersonalisadoComponent);
    const app = fixture.componentInstance;
    fixture.detectChanges();
    const compiled = fixture.nativeElement;
    expect(compiled.querySelector('.borrowed-tools').textContent).toContain('Harry Potter y la Piedra Filosofal');
    expect(compiled.querySelector('.borrowed-tools').textContent).toContain('Cien Años de Soledad');
  });
